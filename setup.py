...
dependencies = [
    ...
    "setproctitle==1.2.2",  # Gives the flora processes readable names
...
kwargs = dict(
    ...
    packages=[
        ...
        "flora.wallet.rl_wallet",
        "flora.wallet.cc_wallet",
        "flora.wallet.did_wallet",
        "flora.wallet.settings",
    ...
    package_data={
        ...
        "flora.wallet.puzzles": ["*.clvm", "*.clvm.hex"],

...
from flora.daemon.client import DaemonProxy, connect_to_daemon_and_validate
from flora.util.service_groups import services_for_groups
...
async def async_start(root_path: Path, group: str, restart: bool) -> None:
    ...
    if daemon is None:
        print("Failed to create the flora daemon")
        return None

...
from flora.cmds.wallet_funcs import print_balance, wallet_coin_unit
from flora.pools.pool_wallet_info import PoolWalletInfo, PoolSingletonState
...
from flora.util.ints import uint16, uint32
        ...
        try:
            ...
            while time.time() - start < 10:
                ...
                if len(tx.sent_to) > 0:
                    ...
                    print(f"Do flora wallet get_transaction -f {fingerprint} -tx 0x{tx_record.name} to get status")
                    return None
        except Exception as e:

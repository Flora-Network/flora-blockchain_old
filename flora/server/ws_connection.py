...
from flora.cmds.init_funcs import flora_full_version_str
from flora.protocols.protocol_message_types import ProtocolMessageTypes
from flora.protocols.shared_protocol import Capability, Handshake
from flora.server.outbound_message import Message, NodeType, make_msg
from flora.server.rate_limits import RateLimiter
...
from flora.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from flora.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSFloraConnection:
    """

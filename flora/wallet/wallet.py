...
from flora.wallet.puzzles.puzzle_utils import (
...
from flora.wallet.secret_key_store import SecretKeyStore
from flora.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_flora(self, flora_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if flora_amount < 0:
            utxos = await self.select_coins(abs(flora_amount), exclude)
        else:
        ...
        flora_amount = spend_value + flora_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": flora_amount}]

...
from flora.types.blockchain_format.program import Program, INFINITE_COST
from flora.types.condition_opcodes import ConditionOpcode
from flora.types.spend_bundle import SpendBundle
from flora.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "flora" in cc_discrepancies:
                    cc_discrepancies["flora"] = cc_discrepancies["flora"] + diff
                else:
                    cc_discrepancies["flora"] = diff

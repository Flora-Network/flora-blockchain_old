...
from flora.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from flora.farmer.farmer import Farmer
from flora.protocols import farmer_protocol, harvester_protocol
from flora.protocols.harvester_protocol import PoolDifficulty
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSFloraConnection
    ):
        """
        ...
        for sp in sps:
            ...
            # If the iters are good enough to make a block, proceed with the block making flora
